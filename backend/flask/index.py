...
from backend.flask.app import setup_app
from backend.flask.cache import get_user_cache
from backend.flask.lti import setup_lti_session, tool_login, get_jwks

load_dotenv()

app, asgi_app, launch_data_storage, cache = setup_app(__name__, static_folder='../../frontend', static_url_path='')
